...
function SchoolPage(){
  ...
  const [schoolsCollection, setSchoolscolletion]=useState({})

  useEffect(()=>{
    fetch('https://neo-app-55ad5-default-rtdb.firebaseio.com/schools/.json')
    .then(response=>response.json())
    .then(json=>{
      setSchoolscolletion(json)
    })
  },[])
      ...
      fetch('https://neo-app-55ad5-default-rtdb.firebaseio.com/schools/.json',{
        ...
        <Container fluid>
          <Row>
            <div className="col-4 bg-dark text-white p-3">
              <Form>
                <FormGroup>
                  ...
                  <Input value={!entryObject.urlimg ? "" : entryObject.urlimg } type="urlimg" name="urlimg" id="urlimg" placeholder="Image" onChange={getEntryData}/>
                </FormGroup>
                <FormGroup>
                <Label for="name">Name</Label>
                <Input value={!entryObject.name?"": entryObject.name}type="name" name="name" id="schoolName" placeholder="Neo educate" onChange={getEntryData}/>
              </FormGroup>
              <FormGroup>
                <Label for="exampleEmail">Email</Label>
                <Input value={!entryObject.email?"":entryObject.email}type="email" name="email" id="exampleEmail" placeholder="example@neoeducate.com.mx" onChange={getEntryData} />
              </FormGroup>
              <FormGroup>
                <Label for="examplePassword">Password</Label>
                <Input value={!entryObject.password?"":entryObject.password}type="password" name="password" id="examplePassword" placeholder="*********" onChange={getEntryData} />
              </FormGroup>
              <FormGroup>
            ...
            <div className="col-8 bg-light d-flex justify-content-start flex-wrap">
              {
                Object.keys(schoolsCollection).map(key=>{
                  let {urlimg,name, country}=schoolsCollection[key]
                  return(
